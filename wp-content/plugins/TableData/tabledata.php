...
function tabledata_loadplugin_textdomain(){
	load_plugin_textdomain("tabledata",false,dirname(__FILE__) ."/languages");
}

add_action("plugins_loaded","tabledata_loadplugin_textdomain");
